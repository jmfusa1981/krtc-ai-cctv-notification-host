...
class InferenceHost(models.Model):
    ...
    station_code = models.CharField(max_length=50, default="KRTC-ST-001", db_index=True)
    host_type = models.CharField(max_length=20, default="physical")
    ip_address = models.GenericIPAddressField(null=True, blank=True)
    port = models.PositiveIntegerField(default=8000)
    health_url = models.URLField(max_length=500, blank=True)
    events_url = models.URLField(max_length=500, blank=True)
    websocket_url = models.CharField(max_length=500, blank=True)
    websocket_auth_mode = models.CharField(max_length=20, default="none")
...
class InferenceConnectionState(models.Model):
    inference_host = models.OneToOneField(InferenceHost, on_delete=models.CASCADE, related_name="connection_state")
    connected = models.BooleanField(default=False)
    last_heartbeat_at = models.DateTimeField(null=True, blank=True)
    health_status = models.CharField(max_length=20, default="unknown")
    websocket_status = models.CharField(max_length=20, default="disconnected")
    ...
    last_source_event_id = models.CharField(max_length=100, blank=True, default="")
    last_successful_event_at = models.DateTimeField(null=True, blank=True)
    last_catchup_at = models.DateTimeField(null=True, blank=True)
